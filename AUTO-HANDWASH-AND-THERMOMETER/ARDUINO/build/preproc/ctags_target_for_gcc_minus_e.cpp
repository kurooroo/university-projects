# 1 "d:\\tunaOneDrive\\OneDrive - Hanoi University of Science and Technology\\tunaOneDriveSync\\tunaProjects\\Mercenary-projects\\AUTO-HANDWASH-AND-THERMOMETER\\ARDUINO\\ARDUINO.ino"
/*
...
*/
# 11 "d:\\tunaOneDrive\\OneDrive - Hanoi University of Science and Technology\\tunaOneDriveSync\\tunaProjects\\Mercenary-projects\\AUTO-HANDWASH-AND-THERMOMETER\\ARDUINO\\ARDUINO.ino"
# 12 "d:\\tunaOneDrive\\OneDrive - Hanoi University of Science and Technology\\tunaOneDriveSync\\tunaProjects\\Mercenary-projects\\AUTO-HANDWASH-AND-THERMOMETER\\ARDUINO\\ARDUINO.ino" 2
# 13 "d:\\tunaOneDrive\\OneDrive - Hanoi University of Science and Technology\\tunaOneDriveSync\\tunaProjects\\Mercenary-projects\\AUTO-HANDWASH-AND-THERMOMETER\\ARDUINO\\ARDUINO.ino" 2
# 14 "d:\\tunaOneDrive\\OneDrive - Hanoi University of Science and Technology\\tunaOneDriveSync\\tunaProjects\\Mercenary-projects\\AUTO-HANDWASH-AND-THERMOMETER\\ARDUINO\\ARDUINO.ino" 2
# 15 "d:\\tunaOneDrive\\OneDrive - Hanoi University of Science and Technology\\tunaOneDriveSync\\tunaProjects\\Mercenary-projects\\AUTO-HANDWASH-AND-THERMOMETER\\ARDUINO\\ARDUINO.ino" 2
# 16 "d:\\tunaOneDrive\\OneDrive - Hanoi University of Science and Technology\\tunaOneDriveSync\\tunaProjects\\Mercenary-projects\\AUTO-HANDWASH-AND-THERMOMETER\\ARDUINO\\ARDUINO.ino" 2
...
void setup()
{
  ...
  // setup SRF05
  pinMode(HUMAN_DETECTION_ECHO_PIN, 0x0);
  pinMode(HUMAN_DETECTION_TRIG_PIN, 0x1);
  pinMode(LIQUID_LEVEL_TRIG_PIN, 0x1);
  pinMode(LIQUID_LEVEL_ECHO_PIN, 0x0);
  // setup cam bien IR phat hien tay de phun dung dich rua tay
  pinMode(HAND_DETECTION_PIN, 0x0);
  // setup dong co bom
  pinMode(PUMP_PIN, 0x1);
  delay(1000);
}
...
void Read_SRF05()
{
  ...
  digitalWrite(HUMAN_DETECTION_TRIG_PIN, 0x0);
  delayMicroseconds(2);
  digitalWrite(HUMAN_DETECTION_TRIG_PIN, 0x1);
  delayMicroseconds(10);
  digitalWrite(HUMAN_DETECTION_TRIG_PIN, 0x0);
  unsigned long duration = pulseIn(HUMAN_DETECTION_ECHO_PIN, 0x1);
  ...
  digitalWrite(LIQUID_LEVEL_TRIG_PIN, 0x0);
  delayMicroseconds(2);
  digitalWrite(LIQUID_LEVEL_TRIG_PIN, 0x1);
  delayMicroseconds(10);
  digitalWrite(LIQUID_LEVEL_TRIG_PIN, 0x0);
  duration = pulseIn(LIQUID_LEVEL_ECHO_PIN, 0x1);
