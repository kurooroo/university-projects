...
; 0000 003A unsigned char temperature = read_adc(0);
; 0000 003B // temperature = temperature << 1;
; 0000 003C data=SPDR;
	ST   -Y,R17
	ST   -Y,R16
;	data -> R17
...
; 0000 0064 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=Out
; 0000 0065 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(3)
	OUT  0x11,R30
; 0000 0066 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=0
...
; 0000 00AD // Only the 8 most significant bits of
; 0000 00AE // the AD conversion result are used
; 0000 00AF ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 00B0 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
...
; 0000 00B4 // SPI Type: Slave
; 0000 00B5 // SPI Clock Rate: 500.000 kHz
; 0000 00B6 // SPI Clock Phase: Cycle Start
; 0000 00B7 // SPI Clock Polarity: Low
; 0000 00B8 // SPI Data Order: MSB First
; 0000 00B9 SPCR=(1<<SPIE) | (1<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (1<<SPR0);
	LDI  R30,LOW(193)
	OUT  0xD,R30
; 0000 00BA SPSR=(0<<SPI2X);
	LDI  R30,LOW(0)
	OUT  0xE,R30
; 0000 00BB 
; 0000 00BC // Clear the SPI interrupt flag
; 0000 00BD #asm
; 0000 00BE     in   r30,spsr
    in   r30,spsr
; 0000 00BF     in   r30,spdr
    in   r30,spdr
; 0000 00C0 #endasm
; 0000 00C1 
