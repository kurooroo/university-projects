...
; .FSTART _spi_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 001F unsigned char data;
; 0000 0020 data=SPDR;
	ST   -Y,R17
;	data -> R17
	IN   R17,15
; 0000 0021 // Place your code here
; 0000 0022 switch(data)
	MOV  R30,R17
	LDI  R31,0
; 0000 0023 {
; 0000 0024     case 1:
...
; 0000 0039 // Function: Bit7=In Bit6=Out Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 003A DDRB=(0<<DDB7) | (1<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(64)
	OUT  0x17,R30
; 0000 003B // State: Bit7=T Bit6=0 Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0045 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=Out
; 0000 0046 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(3)
	OUT  0x11,R30
...
; 0000 0090 // SPI Type: Slave
; 0000 0091 // SPI Clock Rate: 500.000 kHz
; 0000 0092 // SPI Clock Phase: Cycle Start
; 0000 0093 // SPI Clock Polarity: Low
; 0000 0094 // SPI Data Order: MSB First
; 0000 0095 SPCR=(1<<SPIE) | (1<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (1<<SPR0);
	LDI  R30,LOW(193)
	OUT  0xD,R30
; 0000 0096 SPSR=(0<<SPI2X);
	LDI  R30,LOW(0)
	OUT  0xE,R30
; 0000 0097 
; 0000 0098 // Clear the SPI interrupt flag
; 0000 0099 #asm
; 0000 009A     in   r30,spsr
    in   r30,spsr
; 0000 009B     in   r30,spdr
    in   r30,spdr
; 0000 009C #endasm
; 0000 009D 
